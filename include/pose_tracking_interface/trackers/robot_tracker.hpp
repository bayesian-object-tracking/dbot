...
public:
    ...
    // process model
    typedef fl::DampedWienerProcessModel<State>         ProcessModel;
...
#ifdef BUILD_GPU
    typedef fl::KinectImageObservationModelGPUHack<State>   ObservationModelGPUType;
#endif
...
private:  
  ...
  // For debugging
  boost::shared_ptr<fl::RigidBodyRenderer> robot_renderer_;
};
