...
/**
 * \file kinect_image_observation_model_cpu.hpp
...
struct Traits<KinectImageObservationModelCPU<Scalar, State, OBJECTS>>
{
    ...
    typedef std::shared_ptr<dbot::KinectPixelObservationModel>
        PixelObservationModelPtr;
    typedef std::shared_ptr<dbot::OcclusionProcessModel>
        OcclusionProcessModelPtr;
};
}
...
class KinectImageObservationModelCPU
    : public internal::Traits<
          KinectImageObservationModelCPU<Scalar, State>>::ObservationModelBase
{
public:
    typedef internal::Traits<KinectImageObservationModelCPU<Scalar, State>>
        Traits;
