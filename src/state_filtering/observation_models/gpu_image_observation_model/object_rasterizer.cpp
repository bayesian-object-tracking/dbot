...
//            glBeginQuery(GL_TIME_ELAPSED, time_query_[RENDER]);
    ...
    DisplayTimeMeasurements(factors, COMBINED_FAST);
#endif
...
void ObjectRasterizer::DisplayTimeMeasurements(map<int, int> factors, render_type calling_function) {
    ...
    if (poses_rendered_[calling_function] >= n_poses_ * ROUNDS) {
        ...
        cout << endl << "Time measurements for " << function << " averaged over " << poses_rendered_[calling_function] << " poses:" << endl << endl;
