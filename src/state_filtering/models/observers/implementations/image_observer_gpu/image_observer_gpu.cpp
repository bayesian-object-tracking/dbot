...
ImageObserverGPU::~ImageObserverGPU() { }



void ImageObserverGPU::Initialize() {
    if (constants_set_) {
...
std::vector<ImageObserverGPU::ScalarType>
ImageObserverGPU::Loglikes(const std::vector<const StateType *> &states,
...
void ImageObserverGPU::Constants(
...
void ImageObserverGPU::set_number_of_poses(int n_poses) {
    if (initialized_) {
        n_poses_ = n_poses;
...
void ImageObserverGPU::Occlusions(const float& visibility_prob)
{
...
void ImageObserverGPU::Observation(const ObservationType& image, const double& delta_time)
{
...
void ImageObserverGPU::Observation(const std::vector<float>& observations, const ScalarType &delta_time)
{
...
const std::vector<float> ImageObserverGPU::Occlusions(size_t index) const
{
...
void ImageObserverGPU::RangeImage(std::vector<std::vector<int> > &intersect_indices,
...
void ImageObserverGPU::UnregisterResource() {
...
void ImageObserverGPU::RegisterResource() {
    if (!resource_registered_) {
...
//size_t ImageObserverGPU::state_size()
//{
//    return rigid_body_system_->state_size();
//}

//size_t ImageObserverGPU::measurement_rows()
//{
//    return n_rows_;
//}

//size_t ImageObserverGPU::measurement_cols()
//{
//    return n_cols_;
//}
...
void ImageObserverGPU::checkCUDAError(const char *msg)
{
