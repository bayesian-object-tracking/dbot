...
template <
    ...
    int ResRows,
    int ResCols>
class LinearDepthObservationModel;
...
template <
    ...
    int ResRows,
    int ResCols>
struct Traits<LinearDepthObservationModel<State_, Scalar, ResRows, ResCols>>
{
    enum
    {
        PixelObsrvDim = 1,
...
class LinearDepthObservationModel
    : public Traits<
                 LinearDepthObservationModel<State, Scalar, ResRows, ResCols>
             >::ANObservationModelBase,
      public Traits<
                 LinearDepthObservationModel<State, Scalar, ResRows, ResCols>
             >::ObservationModelBase
{
public:
    typedef LinearDepthObservationModel<State, Scalar, ResRows, ResCols> This;
...
public:
    LinearDepthObservationModel(std::shared_ptr<fl::RigidBodyRenderer> renderer,
                          Scalar camera_sigma,
                          Scalar model_sigma,
